  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <h1 class="mt-4 mb-3" style="color:#D2F015; background: rgba(0,0,0,0.5);">
            <!-- <span style=" display:flex;justify-content: center;">Blood Bank & Management</span> -->
            <span style=" display:flex;justify-content: center;">Admin Login</span>
