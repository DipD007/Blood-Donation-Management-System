...
<body>
  ...
  <div id="page-container" style="margin-top:45px; position: relative;min-height: 84vh;">
    <div class="container">
      <div id="content-wrap" style="padding-bottom:75px;">
        ...
        <!-- <div class="col-md-4a" style="margin-top:20px;display:flex; width:fit-content ">
          <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="text-align:center;font-weight:bolder; font-size:xx-large; border:2px solid black; background-color:#C70039;color:white ">Become a Life Saver </a>
        </div> -->

        <div class="d-flex justify-content-center" style="margin-top:20px;">
          <div class="col-md-4a" style="display:flex; width:fit-content;">
            <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="text-align:center; font-weight:bolder; font-size:xx-large; border:2px solid black; background-color:#C70039; color:white;">
              Become a Life Saver
            </a>
          </div>
        </div>
        ...
        <div class="row mb-4">
          ...
          <!-- <div class="col-md-4" style="margin-top:60px">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center;font-weight: bold; background-color:#C70039;color:white ">Become a Life Saver </a>
            </div> -->
        </div>
