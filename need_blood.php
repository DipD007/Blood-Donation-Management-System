...
<div class="mor" style="background-color: #C70039;font-size: x-large; border-radius: 4px; color:white">
  <marquee behavior="" direction="" id="firstMarquee">
   Need Blood Urgent? Go to <a href="contact_us.php">Contact Us</a> -> Send Us a Message!   ─── ⋆⋅☆⋅⋆ ──   To delete your data, go to <a href="contact_us.php">Contact Us</a> -> Send Us a Message "Delete Me :)"
</marquee>
</div>
  <div id="page-container" style="margin-top:10px; position: relative;min-height: 85vh;">
    <div class="container">
                    ...
                    <div class="card" style="width:300px">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          ...
                          <b>Email : </b> <?php echo $row['donor_mail']; ?><br>
