            ...
            <form name="sentMessage" method="post">
              ...
              <div class="control-group form-group">
                <div class="controls">
                  ...
                  <input type="tel" class="form-control" placeholder="Enter 10 digit only"  required maxlength="10" pattern="^\d{10}$" id="phone" name="contactno" required>
                </div>
              </div>
              <div class="control-group form-group">
                <div class="controls">
          ...
          <div class="col-lg-4 mb-4">
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <p>
                <h4>Contact No:</h4><a href="tel:<?php echo $row['contact_phone']; ?>" ><?php echo $row['contact_phone']; ?></a>
                </p>
            <?php }
            } ?>
          </div>
